    ...
    .game_mode_configs = {
        GameModeConfig {
            ...
            .socd_pairs = {
                ...
                SocdPair { .button_dir1 = BTN_LF2, .button_dir2 = BTN_LF4, .socd_type = SOCD_2IP_NO_REAC }, // Changed RF4 to LF4
        ...
        GameModeConfig {
            ...
            .socd_pairs = {
                ...
                SocdPair { .button_dir1 = BTN_LF2, .button_dir2 = BTN_LF4, .socd_type = SOCD_2IP },
